          ...
          <div className="circle2 rounded-circle"></div>
            <div className="position-absolute d-flex flex-column w-100 align-items-center top-10 translate-middle-y ot-header">
              ...
              <div className="d-flex bg-white align-items-center w-50 px-2 py-3 rounded app-shadow mx-3">
                <span className="font-weight-bold app-color-black ml-2 mr-auto text-xs">Ovulation Tracker</span>
              </div>
                  ...
                  <div className="d-flex app-bg-light-white rounded px-4 py-3 app-shadow mx-3">
                    ...
                    <span className="font-weight-bold app-color-black text-xs">PlanIt Assistant</span>
                    </a>
                  </div>
                  <div className="d-flex app-bg-light-white rounded px-4 py-3 app-shadow mx-3">
                    <a href="/history" className="app-color-black" style={{textDecoration: 'none'}}>
                    <span className="font-weight-bold app-color-black text-xs">Go back</span>
                    </a>
                  </div>
            </div>
